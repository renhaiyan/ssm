...
<div class="task-rw-right-2" style="background-image: -webkit-cross-fade(url(pages/img/mark_water.jpg), url(<%=markImage%>), 10%);height:1000px;">
	...
	<table class="easyui-datagrid" title="汇总任务" style="width:auto;height:auto"
			data-options="iconCls:'icon-search',rownumbers:false,singleSelect:true,url:'datagrid_data1.json',showFooter: true,pagination:true,
